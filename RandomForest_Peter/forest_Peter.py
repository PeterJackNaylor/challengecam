...
def _generate_unsampled_indices_Peter(random_state, n_samples, n_bootstrap=None):
    ...
    sample_indices = _generate_sample_indices_Peter(random_state, n_samples, n_bootstrap)
...
def _parallel_build_trees_Peter(tree, forest, X, y, sample_weight, tree_idx, n_trees,
                          verbose=0, class_weight=None, n_bootstrap = None):
...
class PeterBaseForest(six.with_metaclass(ABCMeta, BaseEnsemble,
    ...
    def __init__(self,
                 ...
                 warm_start=False,
                 class_weight=None):
        super(PeterBaseForest, self).__init__(
...
class PeterForestClassifier(six.with_metaclass(ABCMeta, PeterBaseForest,
                                          ClassifierMixin)):
    ...
    def __init__(self,
        ...
        super(PeterForestClassifier, self).__init__(
            base_estimator,
            n_estimators=n_estimators,
            estimator_params=estimator_params,
            bootstrap=bootstrap,
    ...
    def _set_oob_score(self, X, y):
        ...
        """This function was not modified to take into account n_bootstrap """
...
class PeterRandomForestClassifier(PeterForestClassifier):
    ...
    def __init__(self,
                 ...
                 warm_start=False,
                 class_weight=None):
        super(PeterRandomForestClassifier, self).__init__(
