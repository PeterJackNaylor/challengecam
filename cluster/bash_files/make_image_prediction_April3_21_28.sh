...
python $SOURCE_FOLDER/image_prediction2.py --classifier_name=/share/data40T_v2/challengecam_results/training/best_classifier_SVM.pickle --feature_folder=/share/data40T_v2/challengecam_results/Pred_data_set/ --output_folder=/share/data40T_v2/challengecam_results/probmap/pred_data_set_svm --subsample_factor=16 --slide_number=$SGE_TASK_ID
