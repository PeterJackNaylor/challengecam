...
#$ -N Peter_Tumor # name of the job as it will appear in qstat -f
#$ -o logs
#$ -l mem_free=16G 
...
#$ -tc 120 # nbre de job qui peuvent fonctionner en parallèle ensemble
...
python /share/data40T/pnaylor/Cam16/scripts/challengecam/cluster/Data_set.py /share/data40T/pnaylor/Cam16 Tumor $SGE_TASK_ID 0 version_0
