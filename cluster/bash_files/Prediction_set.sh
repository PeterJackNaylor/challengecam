...
python /share/apps/user_apps/challengecam/cluster/Pred_Data_set.py -s $CAM16 -t $FIELD1 -n $FIELD2 -x $FIELD3 -y $FIELD4 -w $FIELD5 --height $FIELD6 -r $FIELD7 -o $CAM16/Pred_data_set
