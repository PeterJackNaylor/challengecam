...
python $SOURCE_FOLDER/slide_generator.py --orig_folder=/share/data40T/pnaylor/Cam16/Test --prob_map_folder=/share/data40T_v2/challengecam_results/probmap/pred_data_set/crops/ --output_folder=/share/data40T_v2/challengecam_results/probmap/pred_data_set/whole_slide --slide_number=$SGE_TASK_ID
