...
python $PYTHON_FILE --source $CAM16 --kfold_file $KFOLD --fold $FIELD1 --n_samples $FIELD2 --version $FIELD3 --n_tree $FIELD4 --m_try $FIELD5 --bootstrap $FIELD6 --save 1 --output $OUTPUT --n_jobs 2