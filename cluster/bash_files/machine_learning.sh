...
python PYTHON_FILE $CAM16/ --source $CAM16 --kfold_file $KFOLD --fold $FIELD1 --n_samples $FIELD2 --version $VERSION --n_tree $FIELD4 --m_try $FIELD5 --bootstrap $FIELD6 --save 0 --output $OUTPUT --n_jobs 1