...
if __name__ ==  "__main__":
	...
	for fn in files:
		...
		skimage.io.imsave(os.path.join(output_folder, slide_name + "_resolution_"+str(resolution)+"_.png"), np.array(image))
		...
		if pref == "Tumor":
			...
			skimage.io.imsave(os.path.join(output_folder, slide_name + "_GT_resolution_"+str(resolution)+"_.png"), np.array(image_GT))
