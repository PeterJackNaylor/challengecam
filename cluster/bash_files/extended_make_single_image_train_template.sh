...
python $SOURCE_FOLDER/image_prediction2.py --classifier_name=/share/data40T_v2/challengecam_results/training/best_classifier.pickle --feature_folder=/share/data40T_v2/challengecam_results/results_on_train --output_folder=/share/data40T_v2/challengecam_results/probmap/train_data_set --subsample_factor=16 --slide_number=1
python $SOURCE_FOLDER/image_prediction2.py --classifier_name=/share/data40T_v2/challengecam_results/training/best_classifier.pickle --feature_folder=/share/data40T_v2/challengecam_results/results_on_train --output_folder=/share/data40T_v2/challengecam_results/probmap/train_data_set --subsample_factor=16 --slide_number=2
python $SOURCE_FOLDER/image_prediction2.py --classifier_name=/share/data40T_v2/challengecam_results/training/best_classifier.pickle --feature_folder=/share/data40T_v2/challengecam_results/results_on_train --output_folder=/share/data40T_v2/challengecam_results/probmap/train_data_set --subsample_factor=16 --slide_number=3
python $SOURCE_FOLDER/image_prediction2.py --classifier_name=/share/data40T_v2/challengecam_results/training/best_classifier.pickle --feature_folder=/share/data40T_v2/challengecam_results/results_on_train --output_folder=/share/data40T_v2/challengecam_results/probmap/train_data_set --subsample_factor=16 --slide_number=4
